	...
	<view class="home">
		...
		<div class="about">
			<div class="type-list">
				...
				<input class="uni-input" @input="onKeyInput" placeholder-style="color:#333;" placeholder="输入名字" />
			</div>
			<div class="type-list">
				<div class="left">
				...
				<input class="uni-input" placeholder-style="color:#333;" @input="onKeyInput" placeholder="输入手机号" />
			</div>
			<div class="type-list">
				<div class="left">
				...
				<input class="uni-input" placeholder-style="color:#333;" @input="onKeyInput" placeholder="输入部门" />
			</div>
		</div>
